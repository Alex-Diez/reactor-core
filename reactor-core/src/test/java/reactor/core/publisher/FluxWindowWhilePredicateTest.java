...
public class FluxWindowWhilePredicateTest extends
	...
	public void onCompletionBeforeLastBoundaryWindowEmitted() {
		...
		FluxWindowWhilePredicate<Integer> windowWhile =
				new FluxWindowWhilePredicate<>(source, Queues.small(), Queues.unbounded(), Queues.SMALL_BUFFER_SIZE,
						i -> i < 3, Mode.WHILE);
	...
	public void normalWhile() {
		...
		FluxWindowWhilePredicate<Integer> windowWhile = new FluxWindowWhilePredicate<>(
    ...
    public void scanMainSubscriber() {
        ...
        FluxWindowWhilePredicate.WindowPredicateMain<Integer> test = new FluxWindowWhilePredicate.WindowPredicateMain<>(actual,
    ...
    public void scanOtherSubscriber() {
        CoreSubscriber<Flux<Integer>> actual = new LambdaSubscriber<>(null, e -> {}, null, null);
        FluxWindowWhilePredicate.WindowPredicateMain<Integer> main = new FluxWindowWhilePredicate.WindowPredicateMain<>(actual,
        		Queues.<Flux<Integer>>unbounded().get(), Queues.unbounded(), 123, i -> true, Mode.WHILE);
        FluxWindowWhilePredicate.WindowFlux<Integer> test = new FluxWindowWhilePredicate.WindowFlux<>(
